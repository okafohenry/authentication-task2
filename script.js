		...
		if((document.getElementById("first-name").value || document.getElementById("last-name").value || document.getElementById("email").value  || document.getElementById("password").value || document.getElementById("conf-password").value) == null && document.getElementById('checkbox').checked == false ){
